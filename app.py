...
Original file is located at
    https://colab.research.google.com/drive/1ukuXOj3I67XMshUAebJrZe0QwAjNpI5U
"""
...
model_1.load_state_dict(torch.load(
    "./model/kdsamedata_wt.pt", map_location=device)) # Load pre-trained weights
...
model_2.load_state_dict(torch.load(
    "./model/teacher_wt.pt", map_location=device)) # Load pre-trained weights
